...
def dbUpdate(lumi, temp, humi):

    json = {'time':time.strftime("%Y-%m-%d %H:%M:%S", time.gmtime()),'luminosity':lumi,'temperature':temp,'humidity':humi}
    print(json)
